...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'stripewebhook_event', 'date',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'stripewebhook_event', 'date')
    ...
    models = {
        u'stripewebhook.event': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
