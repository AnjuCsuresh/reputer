...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationLevel.metadata'
        db.add_column(u'userprofile_notificationlevel', 'metadata',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Adding field 'Profession.metadata'
        db.add_column(u'userprofile_profession', 'metadata',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationLevel.metadata'
        db.delete_column(u'userprofile_notificationlevel', 'metadata')

        # Deleting field 'Profession.metadata'
        db.delete_column(u'userprofile_profession', 'metadata')
