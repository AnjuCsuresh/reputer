...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtendedUser.active'
        db.add_column(u'userprofile_extendeduser', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtendedUser.active'
        db.delete_column(u'userprofile_extendeduser', 'active')
